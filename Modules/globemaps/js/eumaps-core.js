...
const arkadiawaypointsArray = [
	...
	{ id: 'Aakas Island', info: '/wp [Arkadia, 18584, 13748, 100, Aakas Island]', top: '1500px', left: '654px' },
	{ id: 'BIG Industries ALA#05', info: '/wp [Arkadia, 19020, 9046, 100, BIG Ind. LA#05]', top: '59px', left: '1089px' },
	{ id: 'Celeste Harbour', info: '/wp [Arkadia, 29852, 10176, 100, Celeste Harbour]', top: '1431px', left: '1329px' },
	{ id: 'Celeste Harbour Military HQ', info: '/wp [Arkadia, 30120, 10015, 100, Celeste Harbour Military HQ]', top: '1451px', left: '1355px' },
	...
	{ id: 'Cobra Digsite', info: '/wp [Arkadia, 27700, 26852, 100, Cobra Digsite]', top: '390px', left: '1192px' },
	...
	{ id: 'Dauntless Firebase Acadamy', info: '/wp [Arkadia, 21270, 17310, 100, Dauntless Firebase Academy]', top: '986px', left: '792px' },
	{ id: 'Defiant Firebase', info: '/wp [Arkadia, 14792, 19984, 100, Defiant Firebase]', top: '820px', left: '388x' },
	...
	{ id: 'Hawk Digsite', info: '/wp [Arkadia, 10068, 13960, 100, Hawk Digsite]', top: '1194px', left: '94px' },
	{ id: 'IFN Supply Depot', info: '/wp [Arkadia, 29984, 17847, 100, IFN Supply Depot]', top: '1217px', left: '1383px' },
	{ id: 'Implacable Firebase', info: '/wp [Arkadia, 28168, 21960, 100, Implacable Firebase]', top: '698px', left: '1223px' },
	{ id: 'Indomitable Firebase East', info: '/wp [Arkadia, 10636, 30162, 100, Indomitable FB-East]', top: '186px', left: '133px' },
	{ id: 'Indomitable Firebase West', info: '/wp [Arkadia, 10409, 30116, 100, Indomitable FB-West]', top: '189px', left: '116px' },
	{ id: 'Jaguar Digsite resetwp', info: '/wp [Arkadia, 13209, 16166, 100, Jaguar Digsite]', top: '434px', left: '290px' },
	{ id: 'Leapord Digsite resetwp', info: '/wp [Arkadia, 15706, 28653, 100, Leapord Digsite]', top: '280px', left: '444px' },
	{ id: 'Panther Digsite resetwp', info: '/wp [Arkadia, 14314, 27170, 100, Panther Digsite]', top: '369px', left: '359px' },
	{ id: 'Python Digsite resetwp', info: '/wp [Arkadia, 25725, 30128, 100, Python Digsite]', top: '187px', left: '1070px' },
	{ id: 'Kestral Digsite', info: '/wp [Arkadia, 14469, 12603, 100, Kestral Digsite]', top: '1279px', left: '370px' },
	{ id: 'Khorum Coast', info: '/wp [Arkadia, 9100, 27404, 100, Khorum Coast]', top: '357px', left: '35px' },
	{ id: 'Machinery Plant', info: '/wp [Arkadia, 20546, 21850, 100, Machinery Plant]', top: '702px', left: '748px' },
	{ id: 'Mamba Digsite', info: '/wp [Arkadia, 26448, 28365, 100, Mamba Digsite]', top: '297px', left: '1116px' },
	{ id: 'Miltons Crest', info: '/wp [Arkadia, 20208, 28304, 100, Milton`s Crest]', top: '299px', left: '722px' },
	{ id: 'Moshanes Legacy', info: '/wp [Arkadia, 23822, 27840, 100, Machone`s Legacy]', top: '328px', left: '952px' },
	{ id: 'Mutation Station', info: '/wp [Arkadia, 9728,9781, 100, Mutation Station]', top: '1455px', left: '73px' },
	{ id: 'New Arrivals Hangar', info: '/wp [Arkadia, 30315, 17968, 100, New Arrivals Hangar]', top: '945px', left: '1359px' },
	{ id: 'Nursery', info: '/wp [Arkadia, 28872, 24347, 100, Nursery]', top: '548px', left: '1269px' },
	{ id: 'Ocean Lookout', info: '/wp [Arkadia, 31869, 20021, 100, Ocean Lookout]', top: '818px', left: '1454px' },
	...
	{ id: 'Tannery', info: '/wp [Arkadia, 8710, 32286, 200, Tannery] nusuls punies', top: '52px', left: '8px' },
