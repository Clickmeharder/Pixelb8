...
function init() {
  ...
  var ark_mobinfo = new THREE.TextureLoader().load(
  ...
  mapTextures.push(earth_texture, ark_defaulttexture, ark_tptexture, ark_infotexture, ark_mobinfo, earth_displacement, earth_bump, earth_specular);
