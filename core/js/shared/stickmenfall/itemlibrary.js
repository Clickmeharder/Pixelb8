...
// --- WIZARD HATS ---
	"Cloth Hat":         { type: "helmet", style: "wizard", tier: 1,  rarity: 1,  def: 0,  value: 50,     color: "#90caf9" },
	"Cool Hat":          { type: "helmet", style: "wizard", tier: 2,  rarity: 3,  def: 1,  value: 150,    color: "#303f9f" },
	"Magic Hat":         { type: "helmet", style: "wizard", tier: 3,  rarity: 4,  def: 2,  value: 400,    color: "#5c6bc0" },
	"Wizard Hat":        { type: "helmet", style: "wizard", tier: 4,  rarity: 5,  def: 3,  value: 5000,   color: "#4a148c" },
	"Archmage Hate":     { type: "helmet", style: "wizard", tier: 5,  rarity: 7,  def: 4,  value: 12000,  color: "#7b1fa2" },
	"Elementalist Hat":  { type: "helmet", style: "wizard", tier: 6,  rarity: 8,  def: 6,  value: 25000,  color: "#e53935" },
	"Void Hat":          { type: "helmet", style: "wizard", tier: 7,  rarity: 9,  def: 9,  value: 55000,  color: "#311b92" },
	"Star Hat":          { type: "helmet", style: "wizard", tier: 8,  rarity: 10, def: 13, value: 110000, color: "#00e5ff" },
	"Nebula Hat":        { type: "helmet", style: "wizard", tier: 9,  rarity: 11, def: 18, value: 240000, color: "#ea80fc" },
	"Nebula Crown":      { type: "helmet", style: "crown", tier: 9,  rarity: 13, def: 18, value: 1000000, color: "#ea80fc" },
	"Reality Peak":      { type: "helmet", style: "wizard", tier: 10, rarity: 12, def: 25, value: 500000, color: "#ffd600" },
	"Eye of the Cosmos": { type: "helmet", style: "wizard", tier: 11, rarity: 13, def: 40, value: 1200000,color: "#ffffff" },
// --- LURKER HOODS ---
	"Dirty Rag":         { type: "helmet", style: "hood", tier: 1,  rarity: 0,  def: 0,  value: 20,    color: "#555" },
	"Bandit Hood":       { type: "helmet", style: "hood", tier: 2,  rarity: 2,  def: 1,  value: 120,   color: "#333" },
	"Thief Hood":        { type: "helmet", style: "hood", tier: 3,  rarity: 3,  def: 2,  value: 300,   color: "#444" },
	"Rogue Hood":        { type: "helmet", style: "hood", tier: 4,  rarity: 4,  def: 3,  value: 800,   color: "#222" },
	"Cool Hood":         { type: "helmet", style: "hood", tier: 5,  rarity: 5,  def: 4,  value: 2000,  color: "#777" },
	"Stalker Hood":      { type: "helmet", style: "hood", tier: 6,  rarity: 6,  def: 6,  value: 5000,  color: "#555" },
	"Dark Hood":         { type: "helmet", style: "hood", tier: 7,  rarity: 7,  def: 8,  value: 15000, color: "#333" },
	"Lurker Hood":       { type: "helmet", style: "hood", tier: 8,  rarity: 10, def: 11, value: 40000, color: "#222" },
	"Assassin Hood":     { type: "helmet", style: "hood", tier: 9,  rarity: 11, def: 15, value: 95000, color: "#b71c1c" },
	"Phantom Hood":      { type: "helmet", style: "hood", tier: 10, rarity: 12, def: 22, value: 210000,color: "#9e9e9e" },
	"Shadow Hood":       { type: "helmet", style: "hood", tier: 11, rarity: 13, def: 35, value: 550000,color: "#000000" },
//------------------------------------------------------------------------------------------------------
// --------------------------- ARMOR/SHIRT -------------------------------------------------------------
	// --- shirts
