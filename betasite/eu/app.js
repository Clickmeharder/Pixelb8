...
function togglePixelb8More(){
  const section=document.getElementById('pixelb8MoreSection');
  if(!section)return;
  const collapsed=section.classList.toggle('collapsed');
  section.querySelector('.pixelb8-links-toggle')?.setAttribute('aria-expanded',String(!collapsed));
}
...
function initializePixelb8More(){
  ...
  section.querySelector('.pixelb8-links-toggle')?.setAttribute('aria-expanded','false');
}
