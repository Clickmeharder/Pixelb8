...
let currentWeapon = 'laserPistol'; // Default weapon
let players = [];
let playerAvatars = [];
let totalPlayers = '0';
...
function changeWeapon(weaponType) {
    const gunImage = document.getElementById('gun-image');
    const attackSound = document.getElementById('attackSound2');
    const gunLine = document.getElementById('gun-line');

    currentWeapon = weaponType; // Set current weapon
...
// Modify the existing pullGunTrigger to handle different weapons
function pullGunTrigger(player, weaponType = currentWeapon, duration = 300, hideDelay = 300) {
    const gunLine = document.getElementById('gun-line');
    const gunArrow = document.getElementById('gun-arrow');
    ...
    // Array of attack sounds for different weapons
    const attackSounds = {
        laserPistol: document.getElementById('attackSound2'),
        rocketLauncher: document.getElementById('attackSound2') // Example sound
    };

    const randomSound = attackSounds[weaponType];
    randomSound.play();
