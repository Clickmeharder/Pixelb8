...
.remoteFullscreen.mode-desktop .desktopKeys{display:grid!important;position:fixed!important;z-index:98!important;left:calc(env(safe-area-inset-left) + 6px)!important;top:calc(env(safe-area-inset-top) + 42px)!important;bottom:auto!important;width:min(28vw,176px)!important;padding:4px!important;gap:3px!important;border-radius:12px!important;background:rgba(5,10,17,.25)!important;backdrop-filter:blur(4px)!important;border-color:rgba(137,212,244,.14)!important;pointer-events:auto!important;opacity:.86}
