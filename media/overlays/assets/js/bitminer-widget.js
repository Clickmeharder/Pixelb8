...
export class StreamBitMinerWidget extends BaseWidgetModule {
	...
	injectUI() {
        ...
        if (overlayWrapper && !document.getElementById(this.overlayId)) {
            ...
            overlayEl.className = "p8-widget"; // 🎯 Triggers your main app's drag listener automatically!
            overlayEl.style.position = "absolute";
            
            // 📍 Query the global layout key format generated by overlayapp.js mouseup
            ...
            if (savedLayout) {
                ...
                } catch(e) { console.error("Failed parsing global coordinates", e); }
            } else {
                // Fallback default coordinates if never dragged before
        ...
        // 2. Control Panel mount logic stays the same...
